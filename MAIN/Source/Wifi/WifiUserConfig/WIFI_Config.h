...
#define USER_WIFI_VERSION   "V1.0.0.1"	// MCU Version
#define MODEL_NAME_0        "CHPI-7420N" // Model name
#define MODEL_NAME_1        "CHPI-7420N"  // Model name - Optional

#define PRODUCT_CODE_0      "114010"    // Main Product Code Number (POP)
#define PRODUCT_CODE_1      "114010"    // Main Product Code Number (POP) - Optional
...
/* USER DATA SIZE */ 
#define USER_DATA_MAX_SIZE                      120  // The number of A1010 data (Total RX/TX Buffer Size)
#define USER_ERROR_DATA_MAX_SIZE                25  // The number of A1030 data 
#define USER_DATA_MULTI_CONTROL_MAX_SIZE        20  // The number of A1011 data (Data received at once - Group Control)
#define USER_INFO_MAX_SZIE                      20  // The number of A2010 info
#define USER_DIAGNOSIS_MAX_SIZE                 20  // The number of A1091 Diagnosis (When using json data(A1091))
