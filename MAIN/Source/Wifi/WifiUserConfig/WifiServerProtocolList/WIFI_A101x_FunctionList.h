...
typedef enum
{
    ...
    WIFI_FUNC_NUM_114,
    WIFI_FUNC_NUM_115,
    WIFI_FUNC_0116_AMOUNT_OF_ICE,                   //  탱크 얼음량
    WIFI_FUNC_0117,
    WIFI_FUNC_0118,
    WIFI_FUNC_0119,
    WIFI_FUNC_011A_TRAY_HOT_STER_STATE,             // 얼음트레이 고온살균 동작상태
    WIFI_FUNC_011B_TRAY_HOT_STER_HOUR,              // 얼음트레이 고온살균 설정 시간 (시)
    WIFI_FUNC_011C_TRAY_HOT_STER_MINUTE,            // 얼음트레이 고온살균 설정 시간 (분)
    WIFI_FUNC_011D_WAITMODE,                        // 대기모드
    WIFI_FUNC_011E_ONSU_SET_NUM_MIN,                // 최소 온수 설정개수
    WIFI_FUNC_011F_DEFAULT_MY_WATER,                  // 시작MY워터 설정
    WIFI_FUNC_0120_HOT_SETTING_MAX_NUM,             // 최대 온수 설정 개수
