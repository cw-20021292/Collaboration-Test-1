...
const signed char API_TX_STATUS_SEND_CONTROL[]  = "A1014";  // 제어상태정보전송
...
const signed char API_TX_MONITOR_RESPONSE_W[]   = "A9010";  // RAM값 응답 (Write)
const signed char API_TX_MONITOR_RESPONSE_R[]   = "A9012";  // RAM값 응답 (Read)
