...
#define USER_MAX_ITEMS              USER_JSON_MAX_ITEMS              // 최대 키-값 쌍의 수
...
enum
{
    EEPROM_ADDR_WIFI_POWER = 0x00E0,                      // WIFI On/Off State
    EEPROM_ADDR_FIRST_PARING = 0x00E1,                    // WIFI First Paring Check
    EEPROM_ADDR_FOTA_MODULE = 0x00E2,                     // WIFI Module Fota State
    EEPROM_ADDR_FOTA_MCU = 0x00E3,                        // WIFI MCU Fota State
};
