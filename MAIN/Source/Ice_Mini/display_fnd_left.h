...
* Description  :
***********************************************************************************************************************/
#ifndef _DISPLAY_FND_TEMP_H_
#define _DISPLAY_FND_TEMP_H_

//
//extern void start_set_flick( U8 mu8_mode );
extern U8 on_off_flick_timer(U8 flick_time, U8 interval);
extern U8 error_flick_timer(U8 flick_time, U8 interval);
...
extern U8 uv_percent_display_timer(U16 flick_time );
extern U8 get_Fahrenheit( U8 mu8_celcius );
extern void fnd_left_aging_count(void);
...
extern U16 gu16_on_off_flick_timer;
extern U8 gu8_on_off_flick_cnt;
...
extern U8 gu8_display_uv_elapsed_percent;
...
#define FAHRENHEIT_0_DEGREE                                 32
#define CELCIUS_0_DEGREE                                    0


#define FAHRENHEIT_10_DEGREE                                50
#define CELCIUS_10_DEGREE                                   10



#define PREHEAT_DISPLAY_FAHRENHEIT_TEMP_DIFF                2
/*#define PREHEAT_DISPLAY_FAHRENHEIT_TEMP_LOW                 6*/
#define PREHEAT_DISPLAY_FAHRENHEIT_TEMP_LOW                 20




#define PREHEAT_DISPLAY_CELCIUS_TEMP_DIFF                   1
/*#define PREHEAT_DISPLAY_CELCIUS_TEMP_LOW                    3*/
#define PREHEAT_DISPLAY_CELCIUS_TEMP_LOW                    10
