...
* Description  :
***********************************************************************************************************************/
#ifndef _COMP_BLDC_H_
#define _COMP_BLDC_H_
...
#define BLDC_COMP_COMM_PERIOD                               20
#define BLDC_COMP_TX_LENGTH                                 2
/*#define BLDC_COMP_RX_LENGTH                               3*/
#define BLDC_COMP_RX_LENGTH                                 3

#define BLDC_CHECK_CODE                                     0x55


/*..hui [24-11-18오후 4:43:52] 삼성 컴프레셔 에러 번호..*/
...
/*..hui [24-11-18오후 4:48:40] 동작에러 재시도 횟수 10회..*/
#define BLDC_COMP_ERROR_RETRY_COUNT                         10


#if 1
#define BLDC_RX_DATA_ERROR_CODE                              0
#define BLDC_RX_DATA_OPERATION_FREQUENCY                     1
#define BLDC_RX_DATA_CHECK_SUM                               2
#else
#define BLDC_RX_DATA_ERROR_CODE                              0
#define BLDC_RX_DATA_OPERATION_FREQUENCY                     1
#define BLDC_RX_DATA_TEMPERATURE                             2
#define BLDC_RX_DATA_CHECK_SUM                               3
#endif
