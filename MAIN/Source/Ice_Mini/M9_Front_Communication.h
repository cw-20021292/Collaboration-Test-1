...
* Description  :
***********************************************************************************************************************/
#ifndef _FRONT_COMMUNICATION_H_
#define _FRONT_COMMUNICATION_H_

/////extern void Initial_Voice_Next_Lab(void);
...
// Front PBA Type 정보
#define PROTOCOL_FRONT_PBA_CHP                      0x20    // CHP 모델
#define PROTOCOL_FRONT_PBA_CP                       0x21    // CP 모델
#define PROTOCOL_FRONT_PBA_HP                       0x22    // HP 모델
#define PROTOCOL_FRONT_PBA_CHPI                     0x23    // CHPI 모델
#define PROTOCOL_FRONT_PBA_CPI                      0x24    // CPI 모델

/* KEY가 추가됨에 따라 KEY 데이터 버퍼 추가 11->12 250210 @CH.PARK */
#define FRONT_TO_MAIN_DATA_TOTAL_LENGTH        12 // 11

/////#define MAIN_CRC_CALC_RANGE                    66

#define MAIN_TO_FRONT_DATA_TOTAL_LENGTH        95
#define MAIN_CRC_CALC_RANGE                    92
#define FRONT_TX_BUFFER_SIZE                   96

#define DEVICE_ID_ROCATION                     1

/* 데이터 길이 11 -> 12로 증가에 따른 CRC 계산 범위 1증가 250210 @CH.PARK */
#define FRONT_CRC_CALC_RANGE                   9 // 8
#define FRONT_RX_BUFFER_SIZE                   15

/* 데이터 길이 11 -> 12로 증가에 따른 CRC 위치 1증가 250210 @CH.PARK */
#define FRONT_CRC_HIGH_ROCATION                9
#define FRONT_CRC_LOW_ROCATION                 10
...
extern U8 gu8_Key_Water_Extract;
extern U8 gu8_Key_Ice_Extract;
extern U32 gu32_Key_Input;
