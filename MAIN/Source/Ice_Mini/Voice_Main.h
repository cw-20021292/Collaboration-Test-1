...
* Description  :
***********************************************************************************************************************/
#ifndef _VOICE_MAIN_H_
#define _VOICE_MAIN_H_

//
/////extern void Initial_Voice_Next_Lab(void);
extern void ProcessVoice_next_lab(void);
//extern void Voice_Stop_Next_Lab(void);
extern void play_melody_power_on_195( void );
...
#define VOICE_IC_VOICELAND                  0
#define VOICE_IC_NEXT_LAB                   1
#define VOICE_IC_NUVOTON                    2
